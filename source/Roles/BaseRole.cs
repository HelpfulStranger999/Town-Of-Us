...
namespace TownOfUs.Roles
{
    ...
    {
        //public static readonly Dictionary<byte, BaseRole> RoleDictionary = new Dictionary<byte, BaseRole>();
        ...
        //public static IEnumerable<BaseRole> AllRoles => RoleDictionary.Values.ToList();
        ...
        internal virtual bool Criteria()
        {
            ...
            return RoleService.Instance.GetRoles().GetRoleOfPlayer(PlayerControl.LocalPlayer) == this;
        }
        ...
        internal static bool NobodyEndCriteria(ShipStatus __instance)
        {
            bool CheckNoImpsNoCrews()
            {
                ...
                var flag = alives.All(player =>
                {
                    var role = RoleService.Instance.GetRoles().GetRoleOfPlayer(player);
                    if (role == null) return false;
                    var flag2 = role.Faction == Faction.Neutral && !player.Is(RoleEnum.Glitch) && !player.Is(RoleEnum.Arsonist);
                    var flag3 = player.Is(RoleEnum.Arsonist) && ((Arsonist)role).IgniteUsed && alives.Count > 1;
        ...
        internal virtual bool HasNotReachedEndCondition(ShipStatus __instance)
        {
            return true;
        }
        ...
        public static bool operator ==(BaseRole a, BaseRole b)
        {
        ...
        public static BaseRole Gen(Type T, List<PlayerControl> crewmates, CustomRPC rpc)
        {
        ...
        //public static T GetRole<T>(PlayerControl player) where T : BaseRole
        //{
        //    return GetRole(player) as T;
        //}

        //public static BaseRole GetRole(PlayerVoteArea area)
        //{
        ...
        //public static IEnumerable<BaseRole> GetRoles(RoleEnum roletype)
        //{
        ...
        public static class ShipStatus_KMPKPPGPNIH
        {
            public static bool Prefix(ShipStatus __instance)
            {
                ...
                foreach (var role in RoleService.Instance.GetRoles().GetRoles())
                {
                    ...
                    var isend = role.HasNotReachedEndCondition(__instance);
                    ...
                    case StringNames.ExileTextSP:
                        {
                            ...
                            var role = RoleService.Instance.GetRoles().GetRoleOfPlayer(info.Object);
                            if (role == null) return;
        ...
        public static class HudManager_Update
        {
            ...
            private static void UpdateMeeting(MeetingHud __instance)
            {
                ...
                {
                    var role = RoleService.Instance.GetRoles().GetRoleOfPlayer(player.TargetPlayerId);
