...
{
    public class ExportButton : CustomButtonOption
    {
        ...
        {
            SlotButtons.Clear();
            SlotButtons.Add(new SlotButton(null, SlotBehaviorType.Export, 1));
            SlotButtons.Add(new SlotButton(null, SlotBehaviorType.Export, 2));
            SlotButtons.Add(new SlotButton(null, SlotBehaviorType.Export, 3));
            SlotButtons.Add(new CustomButtonOption(1, "Cancel", () => Cancel(FlashWhite)));
